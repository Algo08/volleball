...
class News extends \yii\db\ActiveRecord
{
    ...
    public function rules()
    {
        return [
            ...
            [['text_body_uz', 'text_body_ru', 'text_body_en'], 'string'],
            [['create_date'], 'safe'],
    ...
    public function upload()
    {
        if ($this->imageFile) {
            ...
            \yii\imagine\Image::crop(Yii::getAlias('@webroot') .'/../../frontend/web/img/newsImg/'. $this->imageFile->baseName . '.' . $this->imageFile->extension,330,270)
